...
from KDEF_NEW.data_augmentation import X_train, Y_train_onehot
import absl.logging
...
def two_path(input_tensor, filters, kernel_size, strides=(1, 1), padding='valid'):
    ...
    convH1 = tf.keras.layers.Conv2D(filters=filters_per_group,
                                    ...
                                    strides=strides,
                                    padding=padding,
                                    kernel_regularizer=l2(0.01))(input_groups[0])
    ...
    convL1 = tf.keras.layers.Conv2D(filters=filters_per_group,
                                    ...
                                    strides=strides,
                                    padding=padding,
                                    kernel_regularizer=l2(0.01))(input_groups[1])
...
learning_rate_reducer = ReduceLROnPlateau('val_loss', factor=0.2, patience=9, verbose=1, mode='auto')
