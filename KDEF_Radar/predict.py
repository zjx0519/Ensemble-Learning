...
from KDEF_Radar.PWFS_module import PWFS
from KDEF_Radar.MassAtt_module import MassAtt
import os
import cv2
import numpy as np
...
model = tf.keras.models.load_model(r'F:\chrome_download\LANMSFF-main\LANMSFF-main\KDEF_Radar\model_best.h5', custom_objects=custom_objects)

X_test = []
Y_test = []
image_folder = r'F:\chrome_download\LANMSFF-main\LANMSFF-main\Datasets\Radar4\multi-pos1\test\act'  # 替换成你的图像文件夹路径
