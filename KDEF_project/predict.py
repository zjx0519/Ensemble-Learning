...
model = tf.keras.models.load_model(r'F:\chrome_download\LANMSFF-main\LANMSFF-main\KDEF_project\model_best.h5', custom_objects=custom_objects)

X_test = []
Y_test = []
image_folder = r'F:\chrome_download\LANMSFF-main\LANMSFF-main\Datasets\sorted_kdef_split\test'  # 替换成你的图像文件夹路径
