...
X_train = []
Y_train = []
image_folder = r'F:\chrome_download\LANMSFF-main\LANMSFF-main\Datasets\Multi-Radar\Radar1-2\train'  # 替换成你的图像文件夹路径
...
#                 if image is not None:
                    ...
                    # variants = [image_resized, horizontal_flip, rotated_image]
                    #     # , brightness_image,contrast_image, noise_image]
