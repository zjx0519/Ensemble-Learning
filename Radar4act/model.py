...
from Radar4act.MassAtt_module import MassAtt
from Radar4act.PWFS_module import PWFS
from Radar4act.data_augmentation import X_train, Y_train_onehot
import absl.logging
...
checkpoint = ModelCheckpoint('Radar4act_bestmodel.h5', save_best_only=True, monitor='val_loss', mode='min')
