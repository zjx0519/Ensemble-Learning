...
X_train=[]
Y_train = []
image_folder = r'F:\chrome_download\LANMSFF-main\LANMSFF-main\Datasets\Radar\train'  # 替换成你的图像文件夹路径
...
# 使用 to_categorical 将整数索引转换为独热编码
# 注意：num_classes 参数应该是类别的总数，可以通过 label_binarizer.classes_ 属性获取
print("================================")
